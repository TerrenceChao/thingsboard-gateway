...
setup(
    ...
    author="TerrenceChao",
    author_email="TerrenceHTChao@mobiledrivetech.com",
    license="Apache Software License (Apache Software License 2.0)",
    description="Thingsboard Gateway for IoT devices.",
    # url="https://github.com/TerrenceChao/thingsboard-gateway",
    ...
    packages=['thingsboard_gateway', 'thingsboard_gateway.gateway', 'thingsboard_gateway.gateway.proto', 'thingsboard_gateway.gateway.grpc_service',
              'thingsboard_gateway.storage', 
              'thingsboard_gateway.storage.memory',
              'thingsboard_gateway.storage.file', 
              'thingsboard_gateway.storage.sqlite', 
              'thingsboard_gateway.storage.kafka', 
              'thingsboard_gateway.tb_client',
    ...
    # download_url='https://github.com/TerrenceChao/thingsboard-gateway/archive/%s.tar.gz' % VERSION,
    entry_points={
        'console_scripts': [
